...
class AddTweetModalSheet extends StatefulWidget {
  HomePageNotifier homePageNotifier;
  Function callback;
  AddTweetModalSheet(this.homePageNotifier,this.callback);
  @override
  _AddTweetModalSheetState createState() => _AddTweetModalSheetState();
}

class _AddTweetModalSheetState extends State<AddTweetModalSheet> {
                      ...
                      child: InkWell(
                        ...
                        onTap: ()async{
                          if(_tweetTextEditingController.text.isEmpty){
                            ...
                            Constants.customSnackBar(context: context,content: "Tweet added");
                            widget.callback();
                          }
                        },
                        borderRadius: new BorderRadius.all(new Radius.circular(8)),
                        child: Ink(
                          ...
                          child: new Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                new Text("Tweet",style: GoogleFonts.montserrat(fontSize: 20,fontWeight: FontWeight.w700,color: Colors.white),),
                              ],
                            ),
                          ),
                        ),
